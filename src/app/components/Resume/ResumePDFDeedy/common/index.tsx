...
export const ResumePDFDeedySection = ({
  themeColor,
  heading,
  style = {},
  children,
...
export const ResumePDFDeedyText = ({
  bold = false,
  themeColor,
  style = {},
  children,
...
export const ResumePDFDeedyBulletList = ({
  items,
...
export const ResumePDFDeedyLink = ({
  src,
  isPDF,
  children,
}: {
...
export const ResumeFeaturedSkill = ({
  ...
  return (
    <View style={{ ...styles.flexRow, alignItems: "center", ...style }}>
      <ResumePDFDeedyText style={{ marginRight: spacing[0.5] }}>
        {skill}
      </ResumePDFDeedyText>
